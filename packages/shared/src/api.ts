...
export const API = {
  ...
  collectionNetworks: `${API_PREFIX}/collection-networks`,
  agents: `${API_PREFIX}/agents`,
  collectionAgents: `${API_PREFIX}/collection-agents`,
  projects: `${API_PREFIX}/projects`,
  issues: `${API_PREFIX}/issues`,
  collectionJobs: `${API_PREFIX}/collection-jobs`,
  evidencePackages: `${API_PREFIX}/evidence-packages`,
  ...
  collectionDirectives: `${API_PREFIX}/collection-directives`,
