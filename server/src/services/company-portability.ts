...
function buildManifestFromPackageFiles(
  ...
  for (const agentPath of agentPaths) {
    ...
    manifest.agents.push({
      ...
      collectionSourceType: asString(frontmatter.collectionSourceType) ?? asString(extension.collectionSourceType),
    ...
    if (include.agents) {
      for (const agent of agentRows) {
        ...
        const extension = stripEmptyValues({
          ...
          collectionSourceType: agent.collectionSourceType ?? null,
          adapter: {
      ...
      if (include.agents) {
        for (const planAgent of plan.preview.plan.agentPlans) {
          ...
          const patch = {
            ...
            collectionSourceType: manifestAgent.collectionSourceType,
            reportsTo: null,
